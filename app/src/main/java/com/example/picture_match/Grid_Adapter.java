...
public class Grid_Adapter extends BaseAdapter {
    ...
    public Grid_Adapter(Grid_View grid_page, List<String> arrayList, TextView countdown, ProgressBar progressBar) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        new CountDownTimer(delaytime,1000){
            ...
            public void onFinish() {
                startgame(mask,relativeLayout,position);
            }
        }.start();
        return convertView;
    }
    private void startgame(View mask, RelativeLayout relativeLayout, int position) {
        int interval = 100;
